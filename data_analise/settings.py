"""
Django settings for data_analise project.
...
SECRET_KEY = 'django-insecure-82h=5ly5#-%z$0xr)&(nbw$*^e$!^prv9din$&ik)t^0(2u_(2'
...
WSGI_APPLICATION = 'data_analise.wsgi.application'
...
AUTH_USER_MODEL = 'analise.CustomUser'
